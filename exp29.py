...
"""
Main experiment 29
- Use custom loss to shape embedding to close 1
"""
import numpy as np
import argparse
...
writer = SummaryWriter('../runs/exp-29-' + ' ' + localtime, comment='EXP-29 Layer'+str(n_layers))
os.makedirs('./save', exist_ok=True)
archiveFilePath = './save/exp-29-' + str(n_layers) + ' ' + localtime + '.pt'
